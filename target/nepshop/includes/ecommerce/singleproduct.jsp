...
<html>
  ...
  <body>
    ...
    <section class="single-product section">
        ...
        <div class="single-product-center section-center">
            <div class="single-product-img-container">
                <img src="${product.photo}" alt="${product.name}" class="single-product-img" onerror="this.src='/img/default.jpg'" class="table-img">
            </div>
            <div class="single-product-details">
                <h1 class="single-product-name">${product.name}</h1>
                <span class="single-product-company">${product.company}</span>
                <span class="single-product-price">Rs. ${product.price}</span>
                <p class="single-product-description">${product.description}</p>
                <div class="btn-add-single-product-cart"
                  onclick="addToCart('${product.id}', '${product.name}', '${product.price}', '${product.photo}');">add to cart</div>
            </div>
        </div>
    </section>
    <footer class="footer">
