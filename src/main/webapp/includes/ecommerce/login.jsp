  ...
  <body onload="showToastMessage('${sessionScope.toast[0]}', '${sessionScope.toast[1]}')">
    ...
    <section class="section login">
      <div class="login-center">
        ...
        <form
          class="login-form"
          action="/authservlet?action=login"
          method="post"
        >
          <label for="email">
            enter your email*
            <input type="text" name="email" id="email" />
            <span class="message">email is required</span>
          </label>
          <label for="password">
            enter your password*
          ...
          <button type="submit" type="submit" onclick="return validateForm('login-form');" class="btn-login">login</button>
        </form>
        <div>
