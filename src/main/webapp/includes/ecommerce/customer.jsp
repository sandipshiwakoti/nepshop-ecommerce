...
<html>
  ...
  <body onload="showToastMessage('${sessionScope.toast[0]}', '${sessionScope.toast[1]}')">
    ...
    <section class="section order-section">
        <div class="order-center section-center">
          <h1 class="section-title">checkout</h1>
          <form action="" class="order-form">
            <div class="order-form-group">
              <label>
                Enter shipping address*
                <input type="text" name="shipping_address" value="${sessionScope.customer.address}">
              </label>
              <label>
              ...
              <button class="btn-order" onclick="placeOrder(); return false;">order now</button>
            </div>
           <div>
              <h1 class="cart-title">your shopping cart</h1>
            <div class="cart-items"></div>
            <div class="order-summary">
              <h1 class="order-summary-title">your order summary</h1>
              <div>
    ...
    <div class="${flag ? 'show order-confirm-overlay' : 'order-confirm-overlay'}">
      <div class="order-confirm-modal">
        <span class="success-icon"><i class="fas fa-check-circle"></i></span>
        <h1 class="order-confirm-title">your order is confirmed!</h1>
        <p class="order-confirm-subtitle">we'll send you a shipping confirmation email as soon as order ships.</p>
        <div class="btn-check-order-history" onclick="window.location.href='/orderservlet?action=display_ordered_products';">check order history</div>
      </div>
    </div>
